...
set "ROOT_DIR=%~dp0"
set "PROJECT_FILE=%ROOT_DIR%src\pbi-rest-proxy.csproj"
...
set "PUBLISHED_EXE=%PUBLISH_DIR%\pbi-rest-proxy.exe"
set "ARTIFACT_ZIP=%ARTIFACTS_DIR%\pbi-rest-proxy-%BUILD_SUFFIX%.zip"

if not exist "%ARTIFACTS_DIR%" mkdir "%ARTIFACTS_DIR%"
if not exist "%PUBLISH_ROOT%" mkdir "%PUBLISH_ROOT%"
if exist "%PUBLISH_DIR%" rmdir /s /q "%PUBLISH_DIR%"

echo Publishing pbi-rest-proxy %APP_VERSION%...
